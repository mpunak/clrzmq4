...
# -- pack
dotnet pack ZeroMQ.netcore.csproj -p:NuspecFile=ZeroMQ.net50.nuspec -p:PackageOutputPath=./nupkg --configuration Release
...
# -- consuume
dotnet add package ZeroMQ --version 4.1.0.31-net50
